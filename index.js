                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush bg-transparent">
                                ...
                                <li class="list-group-item bg-transparent text-white"><strong>Borders:</strong> ${border ? border.join(', ') : 'N/A'}</li>
                                ...
                                <li class="list-group-item bg-transparent text-white"><strong>Languages:</strong> ${national_language.join(', ')}</li>
